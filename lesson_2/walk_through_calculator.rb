...
P: input - two numbers, selected operation (2 integers and 1 string)
   ...
   explicit rules: must take 2 integers
                   must selected one of the 4 operators
                   must display result
   implicit rules: does not specific positive or negative - specify not 0
                   must not accept 0
...
#opted to allow negatives since assignment doesn't specific positive 
