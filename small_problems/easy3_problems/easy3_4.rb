...
challenge below: same code, but trying enter an array as the first argument
- returns single array with elements repeated number of times specified by arg 2
=end
